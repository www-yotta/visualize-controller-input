...
const buttonClasses = [
  "", // left
  "absolute top- left-[105px]", // down
  "absolute top-[50px] right-[100px]", //right
  "absolute bottom-0 right-[30px]", // left
  "relative top-[30px]", // top-line-1
  "relative top-[0px]", // top-line-2
  "relative top-[0px]", // top-line-3
  "relative top-[10px]", // top-line-4
  "relative top-[30px]", // middle-line-1
  "relative top-[0px]", // middle-line-2
  "relative top-[0px]", // middle-line-3
  "relative top-[0px]", // external-1-top
  "absolute top-[130px] left-[80px]", // external-lever-1
  "absolute bottom-[40px] right-[140px]", // external-down-1
];

export const TypeB = ({ buttonOrders, artsOrders, input, viewMode }: Props) => {
    return(
                ...
                <div className="flex flex-col gap-[30px] relative left-[-60px]">
                  ...
                  <div className="flex relative w-[600px] gap-[10px]">
                    <Button
                      ...
                      viewMode={viewMode}
                      isPushing={input[buttonOrders[buttonOrders.length - 3]]}
                    >
                      {buttonComponents[artsOrders[buttonOrders.length - 3]]}
                    </Button>
                  ...
                  {/* 下のエリアボタン */}
                  <div className="flex relative w-[600px] gap-[10px]">
                    {buttonOrders.slice(8, 11).map((key, index) => {
                      return (
                        <Button
                          key={key}
